...
TOKEN = '7273976322:AAGkGzq87YHP2GgqX-ZDhjvll9H9RSqX5Xs'
...
FORWARD_CHANNEL_ID = -1002243504176
CHANNEL_ID = -1002243504176
error_channel_id = -1002243504176
...
def attack_command(message):
    ...
    try:
        ...
        if user_data['plan'] == 2 and users_collection.count_documents({"plan": 2}) > 399:
            bot.send_message(chat_id, "*Your Instant++ Plan 💥 is currently not available due to limit reached.*", parse_mode='Markdown')
            return
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/c/2219307694/4*", parse_mode='Markdown')
